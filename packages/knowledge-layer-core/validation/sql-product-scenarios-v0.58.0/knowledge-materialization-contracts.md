...
- Fingerprint: `f8ac815e31826af4b4ac386de97e13dec73f8b467bd8e396e78fc947a6da9eef`
...
- Current KLC materializations: **15**
- Planned Core → KLC materializations: **3**
- Current typed-input materializations: **6**
...
- Expose effective-data-model and its source-layer provenance through Knowledge API without legacy model fallback.
- Expose observed-storage-usage and SQL knowledge through capability-gated Knowledge API projections.
