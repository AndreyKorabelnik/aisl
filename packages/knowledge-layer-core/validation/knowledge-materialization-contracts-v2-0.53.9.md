...
- Fingerprint: `011a879e98c25e6002c57ab28063c9699d2eb62cd9e1b2d7cfb6374acbdcea42`
...
- Planned Core → KLC materializations: **7**
...
|---:|---|---|---|
| 1 | `code_conceptual_model_build` | `code-declared-data-model` | `typed_source_contract_required` |
...
- Current selector: `task_id`
- Task IDs: `data-model`
- Target selector: `typed artifacts and KLC model dependencies for decomposed data-model materializations`
- Transition: `replace_legacy_data_model_task_route_with_code_declared_physical_mapping_and_effective_materializations`
...
- Define typed evidence for code-declared-data-model as the first narrow vertical migration.
- Replace task_id-based KLC import meaning with typed artifact and KLC model routing before switching runtime.
