...
- Fingerprint: `3f58aa5fec7761360c07bdc82acc9271e60644597fa3877fc8c8e626f11aa911`
...
- Current KLC materializations: **12**
- Planned Core → KLC materializations: **5**
- Current typed-input materializations: **4**
...
- typed Core evidence artifact schemas referenced by remaining planned materializations
- runtime registration for typed current materializations that still use legacy entrypoints

## Next steps

- Execute code-declared-data-model, physical-model and logical-physical-mapping through one Runner knowledge execution plan without Runner dispatch changes.
- Add observed-storage-usage as the next independent typed evidence and KLC materialization family.
- Build effective-data-model only as a KLC composition over completed lower-level knowledge artifacts.
