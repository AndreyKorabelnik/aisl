...
- Fingerprint: `053a79c2ba7c05d59fbc6f684d5578fc868d049eb7f4851d766cbdef70cbc0b9`
...
- Обязательные источники:
  - **value-flow-evidence** — `value-flow-evidence`; текущие Core stages: `не Core / ещё не определено`; статус контракта: `proposed`
- Дополнительные источники:
  - **persistence-evidence** — `persistence-evidence`; текущие Core stages: `не Core / ещё не определено`; статус контракта: `proposed`
  - **interaction-boundary-evidence** — `interaction-boundary-evidence`; текущие Core stages: `не Core / ещё не определено`; статус контракта: `proposed`
...
- Обязательные источники:
  - **Java type structure evidence** — `java-type-structure-evidence`; текущие Core stages: `java_source_observation_build, java_structural_scan`; статус контракта: `current`
...
- Обязательные источники:
  - **java-persistence-mapping-evidence** — `java-persistence-mapping-evidence`; текущие Core stages: `не Core / ещё не определено`; статус контракта: `proposed`
- Обязательные знания: `code-declared-data-model`, `physical-data-model`
- Обязательные модели KLC:
  - `code-declared-data-model` из `code-declared-data-model`
  - `physical-data-model` из `physical-model`
- Дополнительные источники:
  - **storage-usage-evidence** — `storage-usage-evidence`; текущие Core stages: `не Core / ещё не определено`; статус контракта: `proposed`
  - **model-evidence-gap** — `model-evidence-gap`; текущие Core stages: `не Core / ещё не определено`; статус контракта: `proposed`
...
- Обязательные источники:
  - **repository-interface-catalog-evidence** — `repository-interface-catalog-evidence`; текущие Core stages: `не Core / ещё не определено`; статус контракта: `proposed`
- Дополнительные источники:
...
- Обязательные источники:
  - **declared-value-evidence** — `declared-value-evidence`; текущие Core stages: `не Core / ещё не определено`; статус контракта: `proposed`
  - **literal-write-evidence** — `literal-write-evidence`; текущие Core stages: `не Core / ещё не определено`; статус контракта: `proposed`
- Дополнительные источники:
  - **java-persistence-evidence** — `java-persistence-evidence`; текущие Core stages: `не Core / ещё не определено`; статус контракта: `proposed`
  - **value-flow-evidence** — `value-flow-evidence`; текущие Core stages: `не Core / ещё не определено`; статус контракта: `proposed`
  - **interaction-boundary-evidence** — `interaction-boundary-evidence`; текущие Core stages: `не Core / ещё не определено`; статус контракта: `proposed`
  - **configuration-evidence** — `configuration-evidence`; текущие Core stages: `не Core / ещё не определено`; статус контракта: `proposed`
...
- Обязательные источники:
  - **sql-analysis** — `sql-analysis`; текущие Core stages: `не Core / ещё не определено`; статус контракта: `current`
- Дополнительные источники:
  - **Предоставленная физическая модель** — `physical-model`; текущие Core stages: `не Core / ещё не определено`; статус контракта: `current`
...
- Обязательные источники:
  - **interaction-boundary-evidence** — `interaction-boundary-evidence`; текущие Core stages: `не Core / ещё не определено`; статус контракта: `proposed`
  - **configuration-evidence** — `configuration-evidence`; текущие Core stages: `не Core / ещё не определено`; статус контракта: `proposed`
  - **build-dependency-evidence** — `build-dependency-evidence`; текущие Core stages: `не Core / ещё не определено`; статус контракта: `proposed`
  - **storage-access-evidence** — `storage-access-evidence`; текущие Core stages: `не Core / ещё не определено`; статус контракта: `proposed`
- Дополнительные источники:
  - **value-flow-evidence** — `value-flow-evidence`; текущие Core stages: `не Core / ещё не определено`; статус контракта: `proposed`
  - **physical-schema-evidence** — `physical-schema-evidence`; текущие Core stages: `не Core / ещё не определено`; статус контракта: `proposed`
...
- Дополнительные источники:
  - **configuration-evidence** — `configuration-evidence`; текущие Core stages: `не Core / ещё не определено`; статус контракта: `proposed`
  - **execution-context-evidence** — `execution-context-evidence`; текущие Core stages: `не Core / ещё не определено`; статус контракта: `proposed`
