...
- Fingerprint: `726655ca796a0b5e747199a0fa1c2665fcdc1bcdfd14e88f86eee43008f3c01f`
...
- Обязательные источники:
  - **java-persistence-mapping-evidence** — `java-persistence-mapping-evidence`; producer/analyzer: `внешний/не зарегистрирован`; статус: `not_applicable`
