...
- Fingerprint: `eed4937d05493c6918c42f2099fa206ee892912e0322862633fd9d9767db9ed0`
...
- Обязательные источники:
  - **Объявления типов и полей в исходном коде** — `java-type-structure-evidence`; текущие Core stages: `java_structural_scan, java_source_observation_build`; статус контракта: `current`
